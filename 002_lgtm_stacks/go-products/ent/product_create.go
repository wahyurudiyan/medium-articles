...
func (pc *ProductCreate) SetDeleteTime(t time.Time) *ProductCreate {
	pc.mutation.SetDeleteTime(t)
	return pc
}

// SetNillableDeleteTime sets the "delete_time" field if the given value is not nil.
func (pc *ProductCreate) SetNillableDeleteTime(t *time.Time) *ProductCreate {
	if t != nil {
		pc.SetDeleteTime(*t)
	}
	return pc
...
func (pc *ProductCreate) SetSku(u uuid.UUID) *ProductCreate {
	pc.mutation.SetSku(u)
	return pc
}

// SetNillableSku sets the "sku" field if the given value is not nil.
func (pc *ProductCreate) SetNillableSku(u *uuid.UUID) *ProductCreate {
	if u != nil {
		pc.SetSku(*u)
	}
	return pc
